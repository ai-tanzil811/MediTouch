...
if (!isset($_SESSION['otp']) || !isset($_SESSION['email'])) {
    ...
    header("Location: patient_login_page.html");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($enteredOtp == $_SESSION['otp']) {
        ...
        $updateQuery = "UPDATE users SET is_active = 1 WHERE user_id = ?";
...
<head>
    ...
    <style>
        ...
        .card {
            background-color: rgb(241, 253, 142, 0.95);
        }
    </style>
</head>
<body>
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="reset-container card shadow">
            ...
            <a href="patient_register.html" class="btn-home mt-3">
